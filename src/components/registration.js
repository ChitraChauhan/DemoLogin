            ...
            <div className="col-md-6 col-md-offset-3">
                ...
                <form name="form" onSubmit={this.handleSubmit}>
                    ...
                    <div className={'form-group' + (submitted && !user.password ? ' has-error' : '')}>
                        ...
                        <input ref="password" type="password" validate={this.pass} className="form-control" name="password" value={user.password}  onChange={this.handleChange} />
...
function validate(values)
{
    ...
    // }
    const pass = value => value && !/^[A-Za-z]\w{7,12}$/i.test(value) ?
        'Password length should be 7-12' : undefined;
